    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-white text-slate-800 rounded-3xl max-w-md p-6 border-0">
        <DialogHeader>
          ...
          {description && (
            <DialogDescription className="text-xs font-semibold text-slate-400 mt-1 leading-relaxed">
              {description}
            </DialogDescription>
          )}
        </DialogHeader>
        <div className="space-y-4 mt-4">
          <div className="space-y-1.5">
            <textarea
              ...
              className="w-full min-h-[100px] p-3 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500 focus:bg-white transition-all resize-none text-slate-800 placeholder:text-slate-400 font-medium"
            />
          </div>
