      ...
      <DialogContent className="bg-white border-slate-200 text-slate-800 rounded-3xl max-w-lg p-6 max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <div className="flex items-center justify-between pr-4">
            ...
            <Badge variant="outline" className="text-[10px] font-bold uppercase bg-slate-100 text-slate-700 border-slate-200">
              Verified Showing
            </Badge>
          </div>
          ...
          <form onSubmit={handleSendOtp} className="space-y-4 py-2">
            ...
            <div className="space-y-1.5">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <MapPin className="h-4 w-4" /> In-Person Showing
                </button>
                <button
                  type="button"
                ...
                >
                  <Video className="h-4 w-4" /> Virtual Video Call
                </button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  className="bg-slate-50 border-slate-200 rounded-xl h-11 text-xs font-semibold focus-visible:ring-2 focus-visible:ring-slate-900/10 focus-visible:border-slate-400"
                  required
                />
              </div>
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full h-11 bg-slate-50 border border-slate-200 rounded-xl px-3 text-xs font-semibold text-slate-800 focus:ring-2 focus:ring-slate-900/10 focus:border-slate-400 focus:outline-none cursor-pointer"
                  required
                >
                  {[
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 text-xs font-semibold text-slate-800 h-20 resize-none focus:ring-2 focus:ring-slate-900/10 focus:border-slate-400 focus:outline-none"
                />
              </div>
            </div>
        ...
        {tourStep === "OTP" && (
          <form onSubmit={handleTourSubmit} className="space-y-5 py-2">
            <div className="bg-slate-50 border border-slate-200 p-4 rounded-2xl text-center space-y-1">
              <UserCheck className="h-8 w-8 text-slate-900 mx-auto mb-1" />
              <p className="text-xs font-bold text-slate-900">Enter Verification Code</p>
            ...
            <div className="space-y-2 text-center">
              ...
              <Input
                ...
                className="w-48 mx-auto text-center font-mono text-xl tracking-[8px] h-12 rounded-xl bg-slate-50 border-slate-300 font-bold focus:ring-2 focus:ring-slate-900/10 focus:border-slate-400"
                required
              />
            </div>
            ...
            <div className="flex justify-between items-center text-xs font-semibold px-2">
              ...
              <button
                ...
                className={`font-bold ${otpCooldown > 0 ? "text-slate-300 cursor-not-allowed" : "text-slate-900 hover:underline"}`}
              >
