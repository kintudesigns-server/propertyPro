...
export default function PaymentsLayout({ children }: { children: React.ReactNode }) {
  ...
  const { allowed, loading, source, reason } = useModuleAccess("payments");
  ...
  if (isOwner && !allowed) {
    return <ModuleLockedBanner module="payments" source={source} reason={reason}>{children}</ModuleLockedBanner>;
  }
