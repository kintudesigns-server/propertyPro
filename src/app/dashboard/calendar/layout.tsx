...
export default function CalendarLayout({ children }: { children: React.ReactNode }) {
  ...
  const { allowed, loading, source, reason } = useModuleAccess("calendar");
  ...
  if (isOwner && !allowed) {
    return <ModuleLockedBanner module="calendar" source={source} reason={reason}>{children}</ModuleLockedBanner>;
  }
