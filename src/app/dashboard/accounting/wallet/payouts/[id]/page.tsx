...
export default function PayoutDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 p-6 md:p-10 max-w-7xl mx-auto space-y-8 pb-28 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 font-sans">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {isRejected && (
            <Card className="bg-rose-50/80 border border-rose-200 rounded-3xl overflow-hidden shadow-xs">
              <CardContent className="p-6 space-y-4 font-sans">
                <div className="flex items-start gap-3">
                  <div className="h-10 w-10 bg-rose-100 border border-rose-200 rounded-2xl flex items-center justify-center text-rose-600 shrink-0 shadow-2xs">
        ...
        <div className="space-y-6 font-sans">
          ...
          <Card className="bg-slate-900 text-white rounded-3xl overflow-hidden shadow-xs font-sans">
            <CardContent className="p-6 space-y-4">
              <div className="h-10 w-10 bg-slate-800 border border-slate-700 rounded-2xl flex items-center justify-center text-amber-400 shadow-2xs">
