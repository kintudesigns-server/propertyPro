...
export default function EditMaintenanceRequestPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (fetching) {
    return <div className="p-12 text-center text-[#6E6E73] font-medium">Loading ticket details...</div>;
  }
        ...
        <Card className="bg-white border-[#E5E5EA] shadow-sm rounded-[24px] overflow-hidden">
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-2.5">
                <Label className="text-[13px] font-bold text-[#1D1D1F] uppercase tracking-wide">Status <span className="text-[#EF4444]">*</span></Label>
