...
export default function TeamLayout({ children }: { children: React.ReactNode }) {
  ...
  const { allowed, loading, source, reason } = useModuleAccess("team_management");
  ...
  if (isOwner && !allowed) {
    return <ModuleLockedBanner module="team_management" source={source} reason={reason}>{children}</ModuleLockedBanner>;
  }
