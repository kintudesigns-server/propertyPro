  ...
  return (
    <div className="p-8 max-w-4xl space-y-6">
      <div className="flex flex-col gap-1">
        <h1 className="text-2xl font-black text-[#0F172A]">Financial Settings</h1>
      ...
      <div className="bg-white border border-[#E2E8F0] rounded-2xl p-6 shadow-sm">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 space-y-4">
            <div>
              <h2 className="text-lg font-bold text-[#0F172A]">Platform Commission Rate</h2>
            ...
            <div className="w-full max-w-xs">
              <label className="block text-sm font-semibold text-[#0F172A] mb-1">Commission Percentage (%)</label>
              <div className="relative">
                <input
                  ...
                  className="w-full border border-slate-300 rounded-lg h-10 px-3 focus:outline-none focus:ring-2 focus:ring-[#635BFF] focus:border-transparent font-medium"
                />
            ...
            <Button
              ...
              disabled={saving}
              className="mt-4 bg-[#635BFF] hover:bg-[#4f46e5] text-white font-bold h-10 px-6 rounded-xl flex items-center gap-2"
            >
