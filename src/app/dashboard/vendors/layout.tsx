...
export default function VendorsLayout({ children }: { children: React.ReactNode }) {
  ...
  const { allowed, loading, source, reason } = useModuleAccess("vendors");
  ...
  if (isOwner && !allowed) {
    return <ModuleLockedBanner module="vendors" source={source} reason={reason}>{children}</ModuleLockedBanner>;
  }
