...
import { Search, RefreshCw, MapPin, Building, BedDouble, Bath, Maximize, LayoutGrid, List, AlignJustify, MoreVertical, Eye, Edit, Trash2, Home, DollarSign, Activity, Square } from "lucide-react";
  ...
  return (
    <div className="w-full max-w-7xl mx-auto pt-6 space-y-6 pb-20">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mb-6">
        <div>
          <h1 className="text-3xl font-bold text-[#0F172A]">Available Units</h1>
          <p className="text-[#64748B] mt-1">Individual units currently available for rent</p>
        </div>
      ...
      <div className="bg-white border border-[#E2E8F0] rounded-2xl shadow-sm overflow-hidden mt-8">
        ...
        <div className="p-5 border-b border-[#E2E8F0] bg-[#F8FAFC]/50 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-bold text-[#0F172A] text-lg">Available Units</h2>
              <p className="text-xs text-[#64748B]">Individual units currently available for rent</p>
            </div>
          </div>
                  ...
                  <TableRow key={u.id} className="border-[#E2E8F0] hover:bg-[#F8FAFC]/80 transition-colors">
                    ...
                    <TableCell>
                      <div className="flex flex-col">
                        ...
                        <span className="text-[11px] text-[#64748B]">{u.property?.type}</span>
                      </div>
                    </TableCell>
                    <TableCell>
                      <div className="flex flex-col">
                        <span className="flex items-center gap-1 font-semibold text-[#0F172A] text-sm">
                          <MapPin className="h-3 w-3 text-[#94A3B8]" />
                          {u.property?.city}, {u.property?.country}
                        </span>
                        <span className="text-[11px] text-[#64748B] ml-4 mt-0.5">{u.property?.address}</span>
                      </div>
                    </TableCell>
                    <TableCell>
