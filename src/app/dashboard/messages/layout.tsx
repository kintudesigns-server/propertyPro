...
export default function MessagesLayout({ children }: { children: React.ReactNode }) {
  ...
  const { allowed, loading, source, reason } = useModuleAccess("messages");
  ...
  if (isOwner && !allowed) {
    return <ModuleLockedBanner module="messages" source={source} reason={reason}>{children}</ModuleLockedBanner>;
  }
