...
export default function EditTenantPage() {
  ...
  if (initialLoading) {
    return <div className="p-10 text-center font-bold text-[#6E6E73]">Loading Tenant Form...</div>;
  }
        ...
        <Card className="bg-white border-[#E5E5EA] shadow-sm rounded-2xl overflow-hidden">
          <CardContent className="p-8 flex flex-col md:flex-row items-center gap-8">
            <div className="relative group cursor-pointer">
              <div className="h-32 w-32 rounded-full bg-[#EFF6FF] text-[#007AFF] border-2 border-dashed border-[#CBD5E1] flex flex-col items-center justify-center group-hover:border-[#007AFF] transition-all">
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 border-t border-[#F1F5F9] pt-6">
              ...
              <div className="space-y-2">
                ...
                <select name="tenantStatus" value={formData.tenantStatus} onChange={handleChange} className="w-full h-11 bg-white border border-[#E5E5EA] rounded-xl px-4 text-sm text-[#1D1D1F] outline-none">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 border-t border-[#F1F5F9] pt-6">
              <div className="space-y-2">
                <label className="text-sm font-bold text-[#1D1D1F]">New Password (Leave blank to keep current)</label>
                <Input type="password" name="password" value={formData.password} onChange={handleChange} placeholder="••••••••" className="h-11 rounded-xl bg-white border-[#E5E5EA]" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-bold text-[#1D1D1F]">Confirm New Password</label>
                <Input type="password" name="confirmPassword" value={formData.confirmPassword} onChange={handleChange} placeholder="••••••••" className="h-11 rounded-xl bg-white border-[#E5E5EA]" />
              </div>
            </div>
          </CardContent>
        </Card>
